    ...
    public static void main(String[] args) {
        for (int i = 0; i < 1000; i++) {
            ...
            System.out.println("{ \n" +
                    "    \"name\" : \"666\", \n" +
                    "    \"search\" : {\n" +
                    "        \"_cls\" : \"UserBookmarkQueryIPListEmbedded\", \n" +
                    "        \"name\" : \"UserBookmarkQueryIPListEmbedded\", \n" +
                    "        \"friendly_name\" : \"IP列表\", \n" +
                    "        \"json_data\" : \"[\\\""+randomIp+"\"]\"\n" +
                    "    }, \n" +
                    "    \"index\" : \"quake_service\", \n" +
                    "    \"user\" : ObjectId(\"5e4a4637b95b6e62ddf7642c\"), \n" +
                    "    \"enable\" : true, \n" +
                    "    \"time\" : ISODate(\"2020-12-10T08:34:51.872+0000\"), \n" +
                    "    \"subscription_status\" : {\n" +
